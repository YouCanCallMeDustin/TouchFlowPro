    ...
    if (recommendations.length === 0) {
        return (
            <div className="card border border-white/5 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-[11px] font-black text-text-muted uppercase tracking-widest opacity-40">Complete drills to generate next intel</p>
            </div>
        );
    }
    ...
    return (
        <div className="card border border-white/5 overflow-hidden">
            <div className="flex items-center gap-4 mb-10 pb-6 border-b border-white/5">
                ...
                <div>
                    <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-text-muted">Target Selection</h3>
                    <div className="text-2xl font-black text-text-main tracking-tighter">Recommended For You</div>
                </div>
            </div>
                            ...
                            >
                                <div className="flex items-start gap-6">
                                    ...
                                    <div className="flex-shrink-0 hidden sm:block">
                                        <div className="text-[10px] font-black text-text-muted/20 uppercase tracking-widest group-hover:text-primary transition-colors">
                                            PRIO_0{index + 1}
                                        </div>
                                    </div>
                                </div>
