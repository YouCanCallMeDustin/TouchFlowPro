        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col gap-16 pb-20">
            ...
            <div className="relative overflow-hidden card group min-h-[220px] flex items-center bg-gradient-to-br from-primary/[0.03] to-secondary/[0.03] border border-white/10 p-8 sm:p-12">
                ...
                <div className="absolute right-12 bottom-12 z-10 hidden md:block">
                    <div className="flex bg-slate-500/5 dark:bg-white/5 p-1.5 rounded-2xl gap-2 border border-slate-200/50 dark:border-white/5 backdrop-blur-md">
                        {(['Beginner', 'Intermediate', 'Professional', 'Specialist'] as DifficultyLevel[]).map(level => {
                            ...
                            return (
                                <button
                                    ...
                                    disabled={!isUnlocked}
                                    className={`
                                        px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all flex items-center gap-3
                                        ${isCurrent
                                            ...
                                            : isUnlocked
                                                ...
                                                : 'text-text-muted/20 cursor-not-allowed opacity-30'}
                                    `}
                                >
                                    {!isUnlocked && <Lock size={12} className="opacity-40" />}
                                    {level}
                                </button>
                            );
                        })}
