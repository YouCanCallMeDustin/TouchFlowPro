...
export const LegalTrack: React.FC<LegalTrackProps> = ({ setStage, setLaunchParams }) => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8">
            <Helmet>
                <title>Legal Transcription & Court Reporter Typing Drills | TouchFlow Pro</title>
                <meta name="description" content="Master specialized legal terminology. Practice typing speed and accuracy for corporate law and litigation. Professional-grade assessment for court reporters and legal assistants." />
                <link rel="canonical" href="https://touchflowpro.com/legal-track" />
                <meta property="og:title" content="Legal Transcription & Court Reporter Typing Drills | TouchFlow Pro" />
                <meta property="og:description" content="Master specialized legal terminology. Practice typing speed and accuracy for corporate law and litigation. Professional-grade assessment." />
                ...
                <meta name="twitter:title" content="Legal Typing Test & Practice For Legal Assistants | TouchFlow Pro" />
                <meta name="twitter:description" content="Professional typing tests and practice drills tailored for the legal industry. Master complex legal terminology and dictation speed." />
                <script type="application/ld+json">
                    {JSON.stringify({
                        "@context": "https://schema.org",
                        "@type": "Course",
                        "name": "Legal Transcription Typing Track",
                        "description": "Master specialized legal terminology and court reporting syntax.",
                        "provider": {
                            "@type": "Organization",
                            "name": "TouchFlow Pro",
