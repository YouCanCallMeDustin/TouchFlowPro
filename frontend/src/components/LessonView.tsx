        ...
        <div className="max-w-5xl mx-auto w-full relative">
            ...
            {mode === 'practice' && (
                <div className="space-y-1 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="bg-slate-500/5 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 text-text-main px-4 py-1.5 rounded-[1rem] shadow-lg flex items-center justify-between border-t border-slate-200/20 dark:border-white/10 relative overflow-hidden">
